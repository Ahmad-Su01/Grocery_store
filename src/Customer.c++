...
void Customer::cart_checking()
{
    ...
    cout << left << setw(25) << "Product name" << left << setw(18) << "Price" << left << setw(15) << "Quantity" << endl;

    if (f.is_open())
    {
        while (f >> name >> price >> quantity)
        {
            cout << left << setw(25) << name << left << setw(18) << price << left << setw(15) << quantity << endl;
        }
        f.close();
        cout << endl
             << endl;
...
void Customer::Payment_taken(const char *file)
{
    ...
    if (j == 1)
    {
        cout << "we are sorry. There are no " << name << " left" << endl
             << endl;
        purchase_display();
    }
    ...
    if (j == 2)
    {
        cout << "What you need is beyong!" << endl
             << endl;
        purchase_display();
    }
